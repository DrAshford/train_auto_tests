...
def test_web1():
    assert selenium_script('http://suninjuly.github.io/registration1.html') == "Congratulations! You have successfully registered!", "Test1 Web1 ERROR"

def test_web2():
    assert selenium_script('http://suninjuly.github.io/registration2.html') == "Congratulations! You have successfully registered!", "Test2 Web2 ERROR"
